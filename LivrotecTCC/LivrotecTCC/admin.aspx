...
<%@ Register Src="~/LHeader.ascx" TagPrefix="Livrotec" TagName="LHeader" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <Livrotec:LHeader runat="server" id="LHeader" />
        ...
        <div class="container" id="areaAdmin">
            ...
            <a href='doacao.aspx' class='aAdmin'>
                <div class='divAdmin'>
                    <svg xmlns='http://www.w3.org/2000/svg' width='150' height='150' preserveAspectRatio='xMidYMid meet' viewBox='0 0 24 24'><path fill='#8A6B32' d='M17.726 13.02L14 16H9v-1h4.065a.5.5 0 0 0 .416-.777l-.888-1.332A1.995 1.995 0 0 0 10.93 12H3a1 1 0 0 0-1 1v6a2 2 0 0 0 2 2h9.639a3 3 0 0 0 2.258-1.024L22 13l-1.452-.484a2.998 2.998 0 0 0-2.822.504zm1.532-5.63c.451-.465.73-1.108.73-1.818s-.279-1.353-.73-1.818A2.447 2.447 0 0 0 17.494 3S16.25 2.997 15 4.286C13.75 2.997 12.506 3 12.506 3a2.45 2.45 0 0 0-1.764.753c-.451.466-.73 1.108-.73 1.818s.279 1.354.73 1.818L15 12l4.258-4.61z' /></svg>
