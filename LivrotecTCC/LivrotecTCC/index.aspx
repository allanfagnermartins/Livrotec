...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Literal ID="litTituloFila1" runat="server"></asp:Literal>

        <main style="margin-top: 16px; margin-bottom: 36px;">
            <div class="areaLivros">
                <asp:Literal ID="litMinhasFilas" runat="server"></asp:Literal>
            </div>
        </main>

        <asp:Literal ID="litTituloFila2" runat="server"></asp:Literal>

        <main style="margin-top: 16px; margin-bottom: 36px;" class="areaLivros">
            <asp:Literal ID="litNaoMinhaFilas" runat="server"></asp:Literal>
        </main>

        <main class="areaLivros">
            <asp:Literal ID="litFilas" runat="server"></asp:Literal>
        </main>
    </form>
</body>
</html>
